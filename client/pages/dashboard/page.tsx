/* Created lib/component and moved into app/layout  */
    ...
    return (
        <div className="p-4 rounded-3xl">
            ...
            <div className="w-full border-2 rounded-lg border-gray-400">
                <input
                    className="h-8 border-3 border-solid rounded-md border-gray-400 w-full"
        ...
        <div className="flex items-center justify-start w-full ">
            ...
            <div className="ml-4 w-5/6">
                <div className="bg-white rounded-lg mt-4 pb-1">
                    <div className="font-bold text-md p-4">
                        Graduated from Coding Boot Camp
                    </div>
                    <div className="p-4">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Cras lobortis, ex nec pretium convallis, mauris ipsum
                        vehicula risus, et mollis massa ante quis diam. Integer
                        pellentesque porta orci vitae mollis. Vestibulum tempus
                        felis efficitur egestas dictum. Mauris congue faucibus
                        nisi, nec scelerisque urna. Lorem. Lorem. Lorem.
                    </div>
                    <div className="ml-4 mb-4">
                        <button className="bg-red-100 rounded-lg px-8 py-2 mr-4">
                            Python
                        </button>
                        <button className="bg-indigo-100 rounded-lg  px-8 py-2 mr-4">
                            JS
                        </button>
                    </div>
                </div>
                ...
                <div className="w-2/4 h-full flex flex-col items-center">
                    <div className="bg-white rounded-lg w-5/6 mt-8">
                        ...
                        <div className="flex items-end justify-end mb-4 w-full">
                            <div></div>
                            <button className="bg-blue-500 rounded-lg text-white px-8 py-2 mr-4">
                                Add +
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg w-5/6 mt-4">
                        ...
                        <div className="ml-4 mb-4">
                            ...
                            <button className="bg-green-100 rounded-lg  px-8 py-2 mr-4">
                                Hobby
                            </button>
                        </div>
                    </div>
...
export default function Home() {
    return (
        <div className="flex flex-col max-w-screen-lg justify-center items-center w-full h-full mx-auto">
            {/* <Header /> */}
            <Body />
            {/* <Footer /> */}
        </div>
